...
) -> typing.Callable[[models.Resource[typing.Any]], typing.Tuple[typing.Any, ...]]:

    def wrapped(entry: models.Resource[typing.Any]) -> typing.Tuple[typing.Any, ...]:
        return tuple(getattr(entry.attributes, sort_option.field) for sort_option in sort_options)
